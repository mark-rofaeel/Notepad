...
JMenuItem cutItem,copyItem, deleteItem, findItem, findNextItem, replaceItem, gotoItem, selectAllItem,Darkmode;
/****************************/
Notepad()
{
...
////////////////////////////////////
	...
	ta.replaceSelection("");
else if(cmdText.equals(fileBlack))
{
	ta.setBackground(new Color(10, 10, 20));
...
Darkmode=createMenuItem(fileBlack,KeyEvent.VK_T,editMenu,KeyEvent.VK_D,this);
...
final String fileBlack ="DarkMode";
